...
- **HOEGAARDEN HALL OF RECORDS**: concept records, BBL's findings and the mayoral
  election speeches.
- The Pintland Economy Pitch, as summarised in the build brief: Duckets, the flat-M2
  rule and town treasuries.
...
The seed's 20 groups, 104 relationships, 7 hazards, 15 canon events and 13 injectable
events are all editable in the app.
